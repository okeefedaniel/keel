...
def _register_admiralty_types():
    ...
    register(NotificationType(
        ...
        default_channels=['in_app', 'email'],
        default_roles=['agency_admin', 'foia_manager', 'foia_officer'],
        priority='high',
    ...
    register(NotificationType(
        ...
        category='Admiralty — FOIA',
        default_channels=['in_app', 'email'],
        default_roles=['agency_admin', 'foia_manager'],
        priority='high',
        link_template='/foia/{foia_request.pk}/',
    ))
    register(NotificationType(
        ...
        category='Admiralty — FOIA',
        default_channels=['in_app', 'email'],
        default_roles=['agency_admin', 'foia_manager', 'system_admin'],
        priority='high',
        link_template='/foia/{foia_request.pk}/',
    ))
    register(NotificationType(
        ...
        category='Admiralty — FOIA',
        default_channels=['in_app', 'email', 'sms'],
        default_roles=['agency_admin', 'foia_manager', 'foia_attorney', 'system_admin'],
        priority='urgent',
        allow_mute=False,
        link_template='/foia/{foia_request.pk}/',
    ))
...
def _register_lookout_types():
    ...
    register(NotificationType(
        ...
        default_channels=['in_app', 'email'],
        default_roles=['admin', 'agency_admin', 'legislative_aid', 'stakeholder'],
        priority='high',
    ...
    register(NotificationType(
        ...
        category='Lookout — Bills',
        default_channels=['in_app', 'email', 'sms'],
        default_roles=['admin', 'agency_admin', 'legislative_aid'],
        priority='high',
        link_template='/bills/{bill.pk}/',
    ))
    register(NotificationType(
...
def _register_bounty_types():
    ...
    register(NotificationType(
        ...
        default_channels=['in_app', 'email'],
        default_roles=['agency_admin', 'coordinator', 'analyst'],
        priority='high',
        link_template='/matching/recommendations/',
    ))
    register(NotificationType(
    ...
    register(NotificationType(
        ...
        default_channels=['in_app'],
        default_roles=['agency_admin', 'coordinator', 'admin'],
        priority='medium',
        link_template='/opportunities/{opportunity.pk}/',
    ))
    register(NotificationType(
...
def register_keel_platform_types():
    ...
    register(NotificationType(
        ...
        default_roles=['admin', 'system_admin', 'agency_admin'],
        priority='high',
